    ...
    return (
        <div id="defaultModal" className="fixed grid place-items-center inset-0 bg-black bg-opacity-50 top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100% - 1rem)]max-h-full">
            ...
            <div className="relative bg-white rounded-lg p-2 w-[80%]">
                ...
                <form className="w-full" onSubmit={(e) => { e.preventDefault(); handleSubmit(e, selectedImgSubCat, setselectedImgSubCat) }}>
                    ...
                    <Card>
                        ...
                        <div className="grid md:grid-cols-3 gap-4 -mx-3 mb-6">
                            ...
                            <div className="w-full px-3">
                                ...
                                <button type="button" onClick={(e) => toggleModalImageSubCat()} className="col-end-5 block mb-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center ">Seleccione</button>
                                {selectedImgSubCat.length > 0 && selectedImgSubCat.map((el) =>

                                    <div className="grid grid-cols-3 gap-4 pb-2  max-md:grid-cols-1 ">
                                        <img width="100px" src={el.secure_url} alt="" />
                                        <button onClick={() => ImageDeleteSelectSubCat(el._id)} type="button" className="h-[40px] row-start-2 row-span-2 block mb-3 text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center">Eliminar</button>
