                    ...
                    <ul className="pt-6">
                        ...
                        {Menus.map((Menu, index) => (
                            <li key={index}
                                ...
                                <a href={`/#/dashadmin/gohcomputer/${Menu.title}`} className={` flex rounded-md p-2 cursor-pointer  hover:bg-light-white text-gray-300 text-sm items-center gap-x-4 ${Menu.gap ? "mt-9" : "mt-2"} ${index === 0 && "bg-light-white"} `}>
