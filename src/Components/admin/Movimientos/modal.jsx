...
const ModalMovimiento = ({toggleModalMovimiento}) => {
   ...
   const {formInit,
    ...
    getdocumento,
    handleChange,
    handleSubmit} =UseMovimiento(stateTokenAdmin)
...
console.log(form)
    ...
    return(
      ...
      <div className="relative bg-white rounded-lg p-2 w-[80%]">
        <button onClick={() => { setform(formInit);toggleModalMovimiento()  }} className="absolute top-5 right-10 font-bold text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 rounded-lg text-sm px-2.5 py-2.5 mr-2 mb-2">X</button>
