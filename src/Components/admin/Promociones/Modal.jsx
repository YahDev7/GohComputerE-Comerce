                    ...
                    <Card>
                        ...
                        <div id="defaultModal" className="fixed grid place-items-center inset-0 bg-black bg-opacity-50  z-50  w-full p-4 overflow-x-auto overflow-y-auto md:inset-0 h-[calc(80% - 1rem)]">
                            <div className="relative bg-white rounded-lg p-2 w-[80%] max-md:w-96 ">
                                ...
                                <button className="bg-blue-700 p-3 rounded-md text-white" onClick={handleSelectProductPromo}>
                                    Seleccionar
                                </button>
                                <button onClick={() => { toggleModalProducto() }} className=" -top-10 right-0 z-10  position-absolute  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  " type="button">X</button>
                                ...
                                <DataTable
                                    ...
                                    striped
                                    expandOnRowClicked
                                    onSelectedRowsChange={handleChangeTableProductoPromo}
                                    expandableRows
                                    expandableRowsHideExpander
                                />
                            </div>
